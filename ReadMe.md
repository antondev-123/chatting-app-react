<h1 style="color: dodgerblue; font-style: italic;" aria-description="Project description: A web application fo WebRTC developed React and Node">React + Node based WebRTC application</h1>
